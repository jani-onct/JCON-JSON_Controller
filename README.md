...
| :----------------------- | :------------------------------------------------ | :------------------------------ |
| **ver1.0.0** | 2025年11月11日 | 基本機能(JSONキー名任意設定，ESP32との接続) |
| **ver1.1.0** | 2025年11月27日 | ダークモード対応，アクセントカラー追加(黄色，オレンジ) |
| **ver1.2.0** | 配信日未定(現在審査中) | 外部ゲームパッド対応，マイコンとの送受信対応，メイン画面のJSONモニタの送信/受信切替，Raspberry Pi Pico Wでの動作確認 |
